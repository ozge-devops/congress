...
(submission 84). Contact: pgunes@infina.com.tr, ozelalkucuk@stu.aydin.edu.tr,
hbenli@infina.com.tr.
...
cached HTML body. This is the public KAP website, not Infina’s production HTML.
Public BGE-M3 in Table 2 is the same list text (`public_m3_not_infina`).
